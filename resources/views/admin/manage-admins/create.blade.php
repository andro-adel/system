...
<div class="card p-5">
  {{-- Admin Form --}}
<form method="post" action="/admin/manage-admins" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div class="form-check form-check-inline">
        <input {{ old('type') == 1 || !old('type') ? "checked" : "" }}  required class="form-check-input" type="radio" name="type" id="active" value="1">
        <label class="form-check-label" for="active">User</label>
      </div>

      <div class="form-check form-check-inline">
        <input {{ (old('type') == 0 && old('type') != null ) ? "checked" : "" }} required class="form-check-input" type="radio" name="type" id="inactive" value="0">
